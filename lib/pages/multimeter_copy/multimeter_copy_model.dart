...
import 'multimeter_copy_widget.dart' show MultimeterCopyWidget;
...
class MultimeterCopyModel extends FlutterFlowModel<MultimeterCopyWidget> {
  ...
  // Stores action output result for [Custom Action - getRssi] action in MultimeterCopy widget.
  int? updatedRssi;
