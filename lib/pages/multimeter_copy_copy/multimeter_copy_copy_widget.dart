...
import 'multimeter_copy_copy_model.dart';
export 'multimeter_copy_copy_model.dart';

class MultimeterCopyCopyWidget extends StatefulWidget {
  const MultimeterCopyCopyWidget({
    super.key,
  ...
  @override
  State<MultimeterCopyCopyWidget> createState() =>
      _MultimeterCopyCopyWidgetState();
}

class _MultimeterCopyCopyWidgetState extends State<MultimeterCopyCopyWidget> {
  late MultimeterCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MultimeterCopyCopyModel());
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: AlignmentDirectional(0.23, -0.23),
                  child: Text(
                    'A',
