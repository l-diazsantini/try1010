...
import 'multimeter_copy_copy_widget.dart' show MultimeterCopyCopyWidget;
...
class MultimeterCopyCopyModel
    extends FlutterFlowModel<MultimeterCopyCopyWidget> {
  ...
  // Stores action output result for [Custom Action - getRssi] action in MultimeterCopyCopy widget.
  int? updatedRssi;
